...
This branch is used to develop **UEFI Redfish EDK2 solution**. The code base of this development would keep rebasing to the edk2 stable tag release, the current edk2 code base is **edk2-stable201811** stable tag.
